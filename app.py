...
st.set_page_config(page_title="S-bot",page_icon=":robot_face:")
st.markdown("<h1 style='text-align:center;'>S-bot</h1>",unsafe_allow_html=True)
...
set_bg_from_url("https://www.ismartrecruit.com/upload/blog/main_image/recruitment_chatbot_definition_features_and_benefits.webp", opacity=0.875)
